...
const BASE_TYPES = ["War", "Farming", "Hybrid", "Trophy", "Anti 3 Star", "Legend League"];
...
const SOCIAL_LINKS = [
  { href: "https://youtube.com/@clashlayoutshub", label: "YouTube",  Icon: YouTubeIcon,  color: "#FF0000" },
  { href: "https://discord.gg/clashlayoutshub",  label: "Discord",  Icon: DiscordIcon,  color: "#5865F2" },
  { href: "https://x.com/clashlayoutshub",       label: "X",        Icon: XIcon,        color: "#FFFFFF" },
  { href: "https://facebook.com/clashlayoutshub",label: "Facebook", Icon: FacebookIcon, color: "#1877F2" },
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-xs text-white/50 leading-relaxed mb-5">
              The most trusted source for Clash of Clans base layouts — tested, verified, and updated for the 2026 meta.
            </p>
          ...
          <div className="col-span-2 md:col-span-1">
            <h4 className="font-semibold mb-3 text-xs uppercase tracking-widest text-white/40">Browse</h4>
          ...
          {/* Base Types */}
          <div>
            <h4 className="font-semibold mb-3 text-xs uppercase tracking-widest text-white/40">Base Types</h4>
          ...
          {/* Info */}
          <div>
            <h4 className="font-semibold mb-3 text-xs uppercase tracking-widest text-white/40">Info</h4>
            <ul className="space-y-2">
              {INFO_LINKS.map(link => (
                <li key={link.href}>
          ...
          {/* Legal */}
          <div>
            <h4 className="font-semibold mb-3 text-xs uppercase tracking-widest text-white/40">Legal</h4>
            <ul className="space-y-2">
        ...
        <div className="mt-10 pt-6 border-t border-white/10">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            <p className="text-xs text-white/40 text-center sm:text-left">
              © {year} ClashLayoutsHub. All rights reserved. Not affiliated with Supercell.
            </p>
            <p className="text-xs text-white/25 text-center sm:text-right">
              Clash of Clans™ is a trademark of Supercell Oy. This site is not endorsed by or affiliated with Supercell.
            </p>
          </div>
        </div>
      </div>
